...
from .views import ViewFriendListHome, CreateFriendRequestView,ViewFriendRequests, ProcessFriendRequestClassView, processFriendRemoval, ViewFriendSharedCredentials
