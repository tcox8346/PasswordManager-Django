...
class SolutionUser(AbstractUser, PermissionsMixin): # Server Based Encryption
    ...
    _key = fields.EncryptedCharField(max_length=KEY_SIZE, blank=False, null=True)
...
class SolutionUserProfile(models.Model): # Server - User Based Encrpytion
    ...
    shared_key = models.CharField(max_length=KEY_SIZE, default='') # A Encryption key used to encrypt and decrypt Credential Records marked as shared by the user, 256 bit key    
